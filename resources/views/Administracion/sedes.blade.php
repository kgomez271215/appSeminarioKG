                        ...
                        <form id="frmNewEmpresa" method="POST" action="{{ route('registerSede') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="idTipoSede" id="idTipoSede" class="form-control" required>
                                    ...
                                    @foreach ($tipoSedes as $tipoSedes2)
                                        <option value="{{ $tipoSedes2->idTipoSede }}">{{ $tipoSedes2->tipoSede }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <tbody>
                            @foreach ($sedes as $sedes)
                                <tr>
                                    <td>{{ $sedes->idSede }}</td>
                                    <td>{{ $sedes->sede }}</td>
                                    <td>{{ $sedes->descripcion }}</td>
                                    <td>{{ $sedes->Tipo->tipoSede }}</td>
                                    <td>{{ $sedes->createdAt }}</td>
                                    <td>
                                        @if ($sedes->estado == 1)
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="idTipoSede" id="idTipoSede" class="form-control" required>
                                                ...
                                                @foreach ($tipoSedes as $tipoSedes)
                                                    <option value="{{ $tipoSedes->idTipoSede }}">
                                                        {{ $tipoSedes->tipoSede }}</option>
                                                @endforeach
                                            </select>
                                        </div>
